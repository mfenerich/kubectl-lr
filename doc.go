...
functionality of `kubectl` with a custom create command for managing and configuring
limitrange resources.

The main feature of this plugin is the `kubectl create limitrange` command, which allows users
...
To create a LimitRange resource with specific limits, use:
	...
	kubectl create limitrange my-limitrange --namespace=my-namespace --max-cpu="1" --min-cpu=100m --max-memory=500Mi --dry-run=client -o yaml
